    ...
    <div style={{ padding: '48px 24px', maxWidth: 960, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div>
            <h1 style={{ fontSize: '1.75rem', fontWeight: 700, letterSpacing: '-0.025em', color: T.text, transition: 'color 0.3s' }}>Setup</h1>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, paddingTop: 4 }}>
          ...
          <button
            onClick={handleSync}
            disabled={syncing}
            style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '7px 14px', fontSize: '0.82rem', fontWeight: 500, border: `1.5px solid ${T.border}`, borderRadius: 7, background: T.inputBg, color: T.text, cursor: 'pointer', whiteSpace: 'nowrap', transition: 'background 0.3s, border-color 0.3s, color 0.3s' }}
          >
      ...
      {/* Banner */}
      {message && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '13px 18px', borderRadius: 8, marginBottom: 18, fontSize: '0.875rem', fontWeight: 500, background: message.type === 'success' ? T.successBg : T.errorBg, border: `1px solid ${message.type === 'success' ? T.successBorder : T.errorBorder}`, color: message.type === 'success' ? T.success : T.error, transition: 'background 0.3s, border-color 0.3s, color 0.3s' }}>
      ...
      <form onSubmit={handleSave}>
        <div style={{ border: `1.5px solid ${T.border}`, borderRadius: 10, overflow: 'hidden', marginBottom: 18, transition: 'border-color 0.3s' }}>
          <div style={tableHead}>
        ...
        {/* Footer */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px', border: `1.5px solid ${T.border}`, borderRadius: 8, background: T.cardHead, transition: 'background 0.3s, border-color 0.3s' }}>
          ...
          <button type="submit" disabled={saving} style={{ padding: '9px 24px', fontSize: '0.875rem', fontWeight: 600, border: 'none', borderRadius: 7, background: T.primary, color: 'white', cursor: saving ? 'default' : 'pointer', opacity: saving ? 0.7 : 1, transition: 'background 0.3s' }}>
