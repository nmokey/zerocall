...
import type { AgentRun } from './agents/without.js';
import { PROMPTS } from '../demo/prompts.js';
...
async function main() {
  ...
  // Pick prompt from CLI arg (by ID or index) or default to p01
  ...
  printHeader(`OneCall Live Trace`, CYAN);
