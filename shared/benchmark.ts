...
/**
 * Runs all 20 prompts through both agents sequentially, prints a comparison
 * table, and outputs aggregate metrics.
 *
 * @param agents - The agent functions to compare.
 */
export async function runBenchmark(agents: BenchmarkAgents): Promise<void> {
